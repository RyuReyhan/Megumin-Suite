...
const meguminTraits = {
    ...
    controversial: [
        "Closeted", "Self-hating gay", "Performatively straight", "Gay-curious", "Bicurious", "Secretly bisexual", "Compulsive heterosexuality", "Outs people", "Violently anti-gay", "Homophobic", "Transphobic", "Transmedicalist", "Internalized homophobia", "Obsessed with others' sexuality", "Refuses to label sexuality", "Performatively queer", "Fetishizes queer identity", "Uses queerness for attention", "Denies being trans", "Secretly attracted to same sex",
        "Codependent", "Avoidant attachment", "Anxious attachment", "Fearful-avoidant attachment", "Love-bombing", "Emotionally unavailable", "Serial cheater", "Compulsive liar to partners", "Jealously possessive", "Stalker tendencies", "Obsessive crush", "Can't let go of ex", "Rebounds constantly", "Falls in love instantly", "Terrified of commitment", "Sabotages relationships", "Tests partners constantly", "Needs constant reassurance", "Ghosts after intimacy", "Marries for money", "Trophy partner seeker", "Settles out of fear", "Stays in toxic relationships", "Enables abusive partners", "Romanticizes suffering", "Confuses obsession with love", "Mistakes control for protection", "Addicted to the honeymoon phase",
        "Controlling partner", "Financially abusive", "Emotionally abusive", "Physically abusive", "Gaslights partners", "Isolates partner from friends and family", "Weaponizes children", "Guilt-trips constantly", "Silent treatment addict", "Plays victim in every fight", "Provokes then claims innocence", "Monitors partner's phone", "Dictates partner's appearance", "Refuses couples therapy", "Tracks partner's location", "Threatens to leave constantly", "Withholds affection as punishment",
        "Racist", "Anti-black", "Anti-asian", "Anti-white", "Antisemitic", "Islamophobic", "Xenophobic", "White supremacist", "Ethnonationalist", "Neo-nazi sympathizer", "Casteist", "Colorist", "Classist", "Ableist", "Fatphobic", "Lookist", "Ageist", "Misogynist", "Misandrist", "Misanthrope", "Incel", "Femcel", "Redpilled", "Blackpilled", "Uses slurs casually", "Tokenizes minorities", "Fetishizes race", "Exoticizes other cultures", "Performatively woke as cover", "Racist but claims not to be", "Picks fights over race", "Believes in racial hierarchy", "Eugenicist",
        "Purity obsessed", "Virgin complex", "Slut-shaming", "Religiously repressed", "Believes sex before marriage is sin", "Masturbation guilt", "Converts partners to abstinence", "Judges others' sexual history", "Obsessed with purity culture", "Sex-positive to an obnoxious degree", "Morally superior about celibacy", "Uses religion to control partner", "Believes homosexuality is sin", "Condemns others' kinks while hiding their own",
        "Alcoholic", "Functional alcoholic", "Drug-addicted", "Heroin addict", "Pill-popper", "Cocaine user", "Cannabis-dependent", "Gambling addict", "Rage-drinks", "Substance abuse triggered by trauma", "Sober but white-knuckling it", "Self-medicates", "Enables others' addictions", "Drinks to socialize only", "Quits and relapses cyclically", "Eating disorder", "Purging", "Restricting", "Binge eating", "Orthorexic", "Exercise-addicted", "Self-harming", "Reckless spending as self-destruction",
        "Nihilist", "Solipsist", "Social Darwinist", "Accelerationist", "Death cult mentality", "Doomsday prepper (paranoid)", "Glorifies violence", "Fetishizes criminals", "True crime obsessive", "Idolizes serial killers", "Believes some people deserve to suffer", "Anti-natalist", "Pro-death penalty zealot", "Believes the homeless deserve it", "Punisher mentality", "Ends justify the means", "No empathy for the weak", "Survivalist at others' expense", "Believes in natural hierarchy", "Fascist-curious", "Edgelord", "Contrarian nihilist", "Doomer",
        "Paranoid", "Dissociative", "Delusional", "Manic", "Depressive", "Cyclothymic", "Hypochondriac", "OCD-adjacent", "Intrusive thoughts", "Rage blackouts", "Emotionally numb", "Suicidal ideation", "Body dysmorphia", "Trichotillomania", "Hoarder", "Compulsive liar", "Compulsive thief", "Pathological envy", "Narcissistic injury spirals", "Persecution complex", "Erotomania", "Shared delusion", "Factitious disorder", "Munchausen by proxy", "Dissociates under stress", "Splits people into all-good or all-evil", "Chronic emptiness", "Identity diffusion",
        "Doxes people", "Spreads rumors as sport", "Catfishes", "Scammer", "Con artist", "Manipulates elderly", "Exploits grieving people", "Fakes illness for sympathy", "Steals from family", "Cheats at everything", "Plagiarist", "Credit-stealer", "Kicks down and kisses up", "Smiles to your face destroys you behind your back", "Charity fraud", "Fake ally", "Weaponizes mental illness for sympathy", "Uses trauma as a manipulation tool", "Collects people's secrets as leverage", "Recruits enablers",
        "Incel mindset", "Male chauvinist", "Anti-feminist", "Believes men shouldn't show emotion", "Equates sensitivity with weakness", "Dominance-obsessed", "Sees women as property", "Refuses to do emotional labor", "Homophobic about own masculinity", "Trophy wife mentality", "Breadwinner-or-nothing complex", "Fragile ego around female success", "Negs constantly", "Pick-up artist", "Refuses to be vulnerable", "Uses tears as manipulation", "Weaponizes victimhood", "Pits women against each other", "Internalized misogyny", "Obsessed with male validation", "Self-worth tied to appearance", "Gold digger", "Sugar baby mentality", "Uses relationships for clout", "Madonna-whore complex about self", "Slut-shames other women", "Sabotages female friendships out of jealousy"
    ],
    proclivities: [
        "Voyeur", "Exhibitionist", "Masochist", "Sadist", "Switch (BDSM)", "BDSM dominant", "BDSM submissive", "Bondage enthusiast", "Rope fetishist", "Sensory deprivation kink", "Pain-pleasure seeker", "Degradation kink", "Praise kink", "Humiliation fetish", "Consensual non-consent fantasy", "Power exchange obsessed", "Control freak in bed", "Totally surrenders control in bed", "Orgasm denial kink", "Edging obsessed",
        "Voyeuristic tendencies in public", "Flashes strangers", "Gets off on being watched", "Sex in public places", "Risk-of-getting-caught arousal", "Somnophilia fantasy",
        "Roleplay-obsessed", "Age-gap roleplay", "Authority figure roleplay", "Uniform fetishist", "Nurse/doctor fetish", "Teacher fetish", "Stranger fantasy", "Anonymous sex seeker", "Glory hole curious",
        "Orgy participant", "Gangbang fantasy", "Cuckolding kink", "Hotwife dynamic", "Breeding kink", "Impregnation fantasy", "Lactation fetish", "Pregnancy fetish", "Macro/micro fantasy",
        "Size queen", "Into very petite partners only",
        "Foot fetishist", "Shoe fetishist", "Sock fetishist", "Leg fetishist", "Hand fetishist", "Neck fetishist", "Hair fetishist", "Teeth fetishist", "Ear fetishist", "Voice fetishist", "Gets aroused by specific accents", "Smell fetishist", "Sweat fetishist",
        "Lingerie fetishist", "Latex fetishist", "Leather fetishist", "Fur fetishist", "Silk obsessed", "Mask fetishist", "Glove fetishist", "Corset fetishist", "High heel fetishist",
        "Tattoo fetishist", "Piercing fetishist", "Scarification attracted to", "Muscular body obsessed", "Softness fetishist", "Body hair fetishist", "Shaved obsessed",
        "Weight gain kink", "Feederism", "Feedee", "Vorarephilia fantasy", "Transformation fantasy", "Robot/doll fantasy", "Objectification kink", "Human furniture kink",
        "Petplay", "Puppy play", "Kitty play", "Ponyplay", "Handler dynamic", "Stuffed animal kink", "Age regression (non-sexual comfort)", "Littlespace dynamic", "Dollification", "Living statue fantasy", "Mummification kink",
        "Wax play", "Fire play curious", "Needle play", "Blood play", "Knife play", "Edge play enthusiast", "Electrostimulation kink", "Temperature play", "Ice and heat obsessed",
        "Tickle fetish", "Breathplay", "Choking kink", "Gagging kink", "Spitting kink", "Biting kink", "Scratching kink", "Bruising kink", "Marking territory on partner",
        "Possessiveness during sex", "Dirty talk essential", "Silent sex only", "Eye contact obsessed during sex", "Refuses eye contact during sex", "Crying kink", "Emotional overwhelm during sex",
        "Aftercare obsessed", "Skips aftercare entirely", "Cuddling after is mandatory", "Leaves immediately after", "Confessional kink", "Shame spiral after sex",
        "Performance-focused", "Orgasm-focused only", "Process over outcome", "Tantric sex obsessed", "Slow and sensual only", "Fast and rough only", "Marathon sessions", "Quickie obsessed", "Spontaneous sex only", "Scheduled sex only", "Morning sex person", "Late night only", "Outdoor sex enthusiast", "Car sex person", "Semi-public spaces",
        "Hypersexual", "Asexual", "Demisexual", "Sapiosexual", "Graysexual", "Fraysexual", "Lithosexual", "Reciprosexual", "Quoisexual", "Aromantic",
        "Polyamorous", "Monogamish", "Swinger", "Open relationship only", "Relationship anarchist", "Solo polyamory", "Nesting partner dynamic", "Friends with benefits only", "Transactional sex", "Emotional connection required", "One-night-stand only", "Rebounds constantly",
        "Porn-addicted", "Amateur porn curious", "Exhibitionist content creator", "Watches partner with others", "Compulsive masturbator", "Nymphomaniac", "Sexually repressed", "Celibate by choice", "Abstinent but struggling", "Virgin complex", "Purity obsessed", "Sex-averse", "Touch-averse", "Sensory processing around touch",
        "Needs lots of foreplay", "Skips foreplay entirely", "Oral sex obsessed", "Refuses oral sex", "Anal obsessed", "Anal-averse", "Mutual masturbation preferred", "Penetration-averse", "Toy-dependent", "Gadget enthusiast in bed", "Pornography-scripted expectations", "Unrealistic sexual expectations", "Compares partners to past lovers",
        "Sexually competitive", "Keeps body count secret", "Obsessed with partner's body count", "Slut-shames partners privately", "Sexually generous", "Selfish in bed", "People-pleaser in bed", "Fakes enjoyment", "Never communicates needs", "Overly communicative during sex", "Narrates everything", "Completely silent", "Laughs during sex", "Cries during sex", "Dissociates during sex", "Deeply present during sex", "Spiritual about sex", "Completely clinical about sex", "Ashamed of own desires", "Proud of own kinks", "Overshares sexual history", "Never discusses sexual past"
    ]
};
...
function generateNumberedList(arr) {
...
function generateTraitInjection() {
    let poolsText = "";
    for (let i = 1; i <= 5; i++) {
        const pos = generateTraitPoolHelper(meguminTraits.positive, 10);
        const neu = generateTraitPoolHelper(meguminTraits.neutral, 10);
        const neg = generateTraitPoolHelper(meguminTraits.negative, 10);
        const con = generateTraitPoolHelper(meguminTraits.controversial, 10);
        const pro = generateTraitPoolHelper(meguminTraits.proclivities, 10);
        ...
        poolsText += `Positive (take first 4 in order; skip only if contradictory):\n${generateNumberedList(pos)}\n`;
        poolsText += `Neutral (take first 4 in order; skip only if contradictory):\n${generateNumberedList(neu)}\n`;
        poolsText += `Negative (take first 4 in order; skip only if contradictory):\n${generateNumberedList(neg)}\n`;
        poolsText += `Controversial (take first 4 in order; skip only if contradictory):\n${generateNumberedList(con)}\n`;
        poolsText += `Proclivities (take first 3 in order; skip only if contradictory):\n${generateNumberedList(pro)}\n`;
    }

    return `[NPC GENERATION RULE]
If you introduce any NEW character(s) in this response, you must build their personality using the trait pools below.
SELECTION METHOD: Traits are numbered 1–10. Take them IN ORDER starting from #1. If a trait contradicts another already-selected trait, the character's gender, orientation, or setting, SKIP it and take the next number instead. The remaining traits (5–10) exist only as fallbacks for skipped ones.
Each new character gets their own distinct pool. They will form the absolute core of the new character's identity. Apply them immediately to their behavior, dialogue, and inner thoughts.
Proclivities are private — they inform how the character thinks and acts but are NOT announced to other characters.
